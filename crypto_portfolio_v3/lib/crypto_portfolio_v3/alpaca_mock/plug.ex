defmodule CryptoPortfolioV3.AlpacaMock.Plug do
  @moduledoc """
  Plug that intercepts Alpaca Broker API requests when `ALPACA_MOCK=1`.

  Wired in via Req's `plug:` option from
  `CryptoPortfolioV3.BrokerFunding.Client.request/3` — the request never
  ...
  alias CryptoPortfolioV3.AlpacaMock.Server
