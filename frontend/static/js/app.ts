...
const VALID_PAGES = ['brokerage', 'holdings', 'contact-us', 'account-setup'];
...
window.dashApp = () => ({
  // State
  page: restoredPage,
  // Investments nav group — expanded by default since it's the only group now.
  traditionalOpen: true,
  ...
  // list of broad-market ETFs and well-known large caps.
  ...
  async init(this: any) {
    ...
    // If the restored page is brokerage/holdings, kick off its data load
