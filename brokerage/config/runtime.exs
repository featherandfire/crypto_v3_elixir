...
#
#     PHX_SERVER=true bin/brokerage start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :brokerage, BrokerageWeb.Endpoint, server: true
end
...
# Brokerage.CompanyProfile falls back to Finnhub free profile.
...
if config_env() == :prod do
  ...
  config :brokerage, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
