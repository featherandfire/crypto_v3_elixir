defmodule Brokerage.RecurringInvestments do
  @moduledoc """
  ...
  Three concerns live here:
    ...
    * Execution — pluck due rows, fire them, advance them. The Scheduler
      GenServer (`Brokerage.RecurringInvestments.Scheduler`) is
  ...
  alias Brokerage.{BrokerageAccounts, BrokerFunding.Client}
      ...
      {:ok, account_id} ->
        ...
        case Client.place_order(account_id, body) do
          {:ok, _} ->
            ...
            Brokerage.Notifications.recurring_fired(investment.user_id, investment)
