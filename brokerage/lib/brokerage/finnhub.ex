defmodule Brokerage.Finnhub do
  @moduledoc """
  ...
  (`Brokerage.News`) falls back to Alpaca-only.
  ...
  Finnhub's raw article list — `Brokerage.News` normalizes the
  ...
  defp cfg, do: Application.get_env(:brokerage, :finnhub, [])
end
