defmodule Brokerage.Market.PctChangePrefetcher do
  @moduledoc """
  ...
  alias Brokerage.Market.{CoinGecko, CryptoCompare, PctChange}
  ...
  defp cfg, do: Application.fetch_env!(:brokerage, :pct_change_prefetcher)
