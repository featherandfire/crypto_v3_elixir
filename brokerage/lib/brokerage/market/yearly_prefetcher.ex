defmodule Brokerage.Market.YearlyPrefetcher do
  @moduledoc """
  ...
  alias Brokerage.Market.{CoinGecko, YearlyStat, YearlyVolatility}
  ...
  defp cfg, do: Application.fetch_env!(:brokerage, :yearly_prefetcher)
