defmodule BrokerageWeb.Router do
  use BrokerageWeb, :router
  ...
  pipeline :authenticated do
    plug BrokerageWeb.Plugs.Auth
  end

  scope "/api", BrokerageWeb do
    pipe_through :api
  ...
  if Application.compile_env(:brokerage, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: BrokerageWeb.Telemetry
