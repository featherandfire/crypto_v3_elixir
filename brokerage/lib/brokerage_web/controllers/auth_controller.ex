defmodule BrokerageWeb.AuthController do
  use BrokerageWeb, :controller

  alias Brokerage.{Accounts, Emails, Mailer}
  alias Brokerage.Accounts.{Token, User}
  alias BrokerageWeb.Serializer
  ...
  defp issue_token(%User{id: id}) do
    Token.sign(
      %{"sub" => id},
      Application.fetch_env!(:brokerage, :jwt_secret),
      Application.fetch_env!(:brokerage, :jwt_ttl_seconds)
    )
  end
